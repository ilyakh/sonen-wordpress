        ...
        <div class="preview page-preview" style="background-image: url('<?php echo get_template_directory_uri(); ?>/img/wiki-thumbnail.png'); background-repeat: no-repeat;">
            <div class="row-fluid">
                <div class="span6 description">
                    ...
                    <a href="http://sonen.ifi.uio.no/wiki/" rel="bookmark">
                        En wiki er et samarbeidsprosjekt, så hvis du syns at noen mangler kan du selv hjelpe med å gjøre vår mer fullstendig; du kan opprette en konto og redigere wikien
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="preview page-preview" style="background-image: url('<?php echo get_template_directory_uri(); ?>/img/arrangementer-thumbnail.jpg'); background-repeat: no-repeat;">
            <div class="row-fluid">
                <div class="span6 description">
                    ...
                    <a href="" rel="bookmark">
                        Foredrag, verksteder og andre arrangementer i regi av Åpen Sone for Eksperimentell Informatikk.
                    </a>
                </div>
            </div>
        </div>    
